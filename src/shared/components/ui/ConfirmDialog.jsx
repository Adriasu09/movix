  ...
  return (
    ...
    >
      ...
      >
        ...
        {description && (
          <p className="mt-sm text-main-sm text-text-secondary">{description}</p>
        )}
        ...
        <div className="mt-lg flex justify-end gap-sm">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={`inline-flex items-center justify-center rounded-mvx-md px-md py-xs text-main-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-card ${
              danger
